...
def shortcut_arrow(new : str):
    os.mkdir('C:\\Plume')
    os.rename(new, 'C:\\Plume\\shortcutarrow.ico')
...
ctk.CTkButton(tabview_shortcutarrow, text="•••", width=50, fg_color='#ffd600', hover_color='#434343', text_color='#181818', command=getPath).place(x=280, y=20, anchor=ctk.NW)
...
ctk.CTkButton(tabview_shortcutarrow, text="Apply the modification", width=310, fg_color='#ffd600', hover_color='#434343', text_color='#181818', command=getPath).place(x=20, y=290, anchor=ctk.NW)
